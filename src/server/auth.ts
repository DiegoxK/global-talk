    ...
    signIn: async ({ user, account }) => {
      if (account) {
        ...
        if (userEmail) {
          ...
          return `/join?redirected=${userEmail}`; //if the email does not exist in the User schema, redirect them to the pricing page with the email pre-filled in the form
        }
      }
