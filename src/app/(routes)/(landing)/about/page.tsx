...
export default function About() {
  return (
    <>
      <section className="my-16 flex justify-center gap-10">
        <div className="w-[615px] space-y-6">
          <div className="space-y-4 pr-8">
            ...
            <p>
              ...
              Medellín y resto de Colombia, proporcionando una educación de
              inglés de alta calidad adaptada a sus necesidades corporativas y
              académicas respectivamente. A través de métodos de enseñanza
              innovadores y recursos digitales avanzados, nos dedicamos a ayudar
              a nuestros estudiantes a alcanzar sus metas culturales y
              lingüísticas en el idioma inglés, y a destacarse en el competitivo
              mercado global.
            </p>
          </div>
