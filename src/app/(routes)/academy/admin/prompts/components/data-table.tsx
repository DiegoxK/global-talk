...
interface DataTableProps<TData extends Prompt, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
}

export function DataTable<TData extends Prompt, TValue>({
  columns,
  data,
}: DataTableProps<TData, TValue>) {
  const [prompt, setPrompt] = useState<Prompt | undefined | null>();
