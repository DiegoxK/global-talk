  ...
  return (
    <section className="mt-16 flex flex-wrap justify-center gap-10 md:gap-28 lg:flex-nowrap lg:justify-normal">
      ...
      <div className="relative w-fit space-y-6 text-center">
        ...
        <Hat className="absolute right-0 top-[-15%] fill-primary-100 lg:hidden" />
        <Planet className="absolute bottom-[-15%] left-[-16%] hidden fill-primary-100 lg:block" />
      </div>
      <div className="relative mb-20 space-y-3 self-center md:mb-0">
        <Hat className="absolute right-0 top-[-15%] hidden fill-primary-100 lg:block" />
        <Planet className="absolute bottom-[-16%] left-[-6%] fill-primary-100 lg:hidden" />
