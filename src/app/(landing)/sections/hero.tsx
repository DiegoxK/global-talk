...
export default function Hero() {
  return (
    <section className="my-16 flex gap-28">
      <div className="relative w-fit space-y-6 text-center">
        <div className="relative flex">
          ...
          <Logo
            ...
            height={291}
          />
          <Elipse className="fill-primary-100 absolute bottom-0 left-[25%] z-[-1]" />
        </div>
        ...
        <Planet className="fill-primary-100 absolute bottom-[-15%] left-[-16%]" />
      </div>
      <div className="relative space-y-3 self-center">
        <Hat className="fill-primary-100 absolute right-0 top-[-15%]" />
